    ...
    <div class="container">
        ...
        <?php
            if (isset($_SESSION['cart_item']) && !empty($_SESSION['cart_item'])) {
                include 'src/template/shared/button_shopping_cart.php';
        ?>
                    ...
                    <?php 
                        foreach($_SESSION['cart_item'] as $productId => $item) {  ?>
                            <tr>
                                ...
                                <td><?= $item['name']; ?></td>
                                <td>
                                    <form action="src/action/add_cart.php?action=update" method="post">
                                ...
                                <td>
                                    <a href="src/action/remove_cart.php?product_id=<?= $productId ?>" class="red-button small-button"> <i class="fas fa-trash-alt"></i></a>
                                </td>
                            </tr>
                <?php   } ?>
                    </tr>
